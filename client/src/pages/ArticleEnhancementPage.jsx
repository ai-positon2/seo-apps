...
export default function ArticleEnhancementPage() {
  ...
  return (
    <>
      ...
      `}</style>
      {/* The app header already says where you are; the second "‹ All tools /
          Enhance Existing Article" bar that used to sit here repeated it. */}
      <PageFrame
        title="Enhance Existing Article"
        purpose="Paste the address of a live article. It compares the article with the pages that rank for the same topic and returns an improved version, with every change highlighted."
        width="wide"
      >

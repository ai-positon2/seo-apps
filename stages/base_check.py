def build_prompt(topic: str, content: str, post_type: str, location: str = "") -> str:
    char_count = len(content)

    return f"""Review the following BASE GBP post content against the client's brand guidelines.
...
4. Character Count — Is the post within the client's character limit? (current: {char_count} chars)
